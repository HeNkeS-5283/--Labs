...
namespace Lab6_2
{
    interface ILong
    {
        abstract int longname(string[] arr);
        abstract int longparticipant(int[] arr);
    }


    public class Conference : MidlPaticipant, ILong
    {
        private string name;
        ...
        public int longname(string[] arr)
        {
            string str;
            int x = 0, n;
            n = arr.Length;
        ...
        public int longparticipant(int[] arr)
        {
            int x = 0, n, max;
            n = arr.Length;
                            ...
                            case 'p':
                                {
                                    ...
                                    x = conference.longparticipant(arri);
