...
namespace Lab6_1
{
    interface ISearch
    {
       int[] searchname(string[] arr, string str);
    }
    ...
    {
        public int[] searchname(string[] arr, string str)
        {
            int n, i = 0;
            string str_copy;
            n = arr.Length;
                            ...
                            case 'p':
                                {
                                    while (act1 != "")
                                    {
                                        ...
                                        for (int j = 0; j < n; j++)
                                        {
                                            arrs[j] = product[j].Name;
                                        }
                                        Program program = new Program();
                                        int[] arri = program.searchname(arrs, str);
                                        x = arri.Length;
                                        ...
                                        if (x != 0)
                                        {
                                            ...
                                            for (int j = 0; j < n; j++)
                                            {
                                                for (int k = 0; k < x; k++)
                                                {
                                                    if (j == arri[k])
                                                    {
                                                        Console.WriteLine(product[j].Num + "; " + product[j].Name + "; " + product[j].Size + "; " + product[j].Type + "; " + product[j].Date + ";\n");
                                                    }
                                                }
                                            }
                                        }
